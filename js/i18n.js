const translations = {
    en: {
        ...
        "stores": "Stores",
        "footer-rights": "© 2024 DevPortfolio. All rights reserved.",
        // Skills
    ...
    es: {
        ...
        "button-hire": "Contrátame",
        "button-cv": "Descargar CV",
        "hero-badge": "Disponible para nuevos proyectos",
        "hero-title": "Construyendo el Futuro de las Experiencias <span class='text-primary'>Móviles</span>.",
        ...
        "stats-projects": "Más de 5 proyectos entregados",
        "stats-experience": "7 años de experiencia",
        ...
        "app-store": "App Store",
        "project-suscrito-title": "App de Gestión: Suscrito",
        "project-suscrito-desc": "Una aplicación nativa diseñada para gestionar y trackear tus suscripciones mensuales. Ofrece recordatorios de pago, análisis de gastos y categorización inteligente para mantener tus finanzas bajo control.",
        "project-crolocha-title": "E-commerce: Crolocha",
        "project-crolocha-desc": "Plataforma de comercio electrónico completa con navegación fluida y gestión de carrito de compras. Conectada a una API robusta para manejo de inventario y pedidos en tiempo real.",
        "project-codebiz-title": "Gestor Comercial: CodeBiz",
        "project-codebiz-desc": "Una solución integral para la gestión de productos y ventas en movilidad. Escaneo de códigos de barras, gestión de inventario en tiempo real y paneles de control intuitivos para administradores y empleados.",
        "view-progress": "Avance",
        "stores": "Tiendas",
        "footer-rights": "© 2024 DevPortfolio. Todos los derechos reservados.",
        // Skills
        "skills-title": "Habilidades Técnicas",
        "skills-desc": "Un conjunto de herramientas completo para crear experiencias móviles nativas y multiplataforma de alto rendimiento, respaldado por una sólida comprensión del backend y el diseño.",
        "filter-all": "Todas",
        "filter-mobile": "Móvil",
        "filter-backend": "Web",
        "filter-backend": "Backend",
        ...
        "tech-projects-btn": "Ver proyectos con estas tecnologías",
        // Contact
        "contact-badge": "Disponible para contratación",
        "contact-title": "Construyamos algo <span class='text-primary'>grande.</span>",
        "contact-desc": "Siempre estoy abierto a discutir nuevos proyectos móviles o sitios web, ideas creativas u oportunidades para ser parte de tu visión.",
        ...
        "remote-friendly": "Remoto amigable 🌍",
        "label-name": "Nombre",
        "label-email": "Correo",
